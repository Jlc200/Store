class Carrito {
    ...
    insertarCarrito(producto){
        ...
        row.innerHTML = `
            ...
            <td>
                <a href="#" class="borrar-producto fa-solid fa-trash" style="text-decoration: none;" data-id="${producto.id}"></a>
            </td>
        `;
    ...
    <input type="number" class="form-control cantidad" min="1" value=${producto.cantidad}>
                ...
                <td>
                    <a href="#" class="borrar-producto fa-solid fa-trash" style="font-size:30px; text-decoration: none;" data-id="${producto.id}"></a>
                </td>
            `;
...
document.getElementById('subtotal').value = "S/. " + subtotal;
        document.getElementById('igv').value = "S/. " + igv;
